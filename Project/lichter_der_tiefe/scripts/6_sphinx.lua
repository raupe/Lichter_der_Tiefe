...
function damage(me, attacker, bone, damageType, dmg)
    if getFlag(v.flagNejl) ~= 1 then
        setControlHint(DATA_TEXTS.sphinx_diag_4, 0,0,0, 4)
...
function dieNormal(me)
    ...
    setControlHint(DATA_TEXTS.sphinx_diag_5, 0,0,0, 3)
end
